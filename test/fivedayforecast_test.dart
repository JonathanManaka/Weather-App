...
void main() {
  ...
  test('Server request succeeded', () async {
    ...
    int statusCode;
    FiveDaysForecastService fiveDayForecastService = FiveDaysForecastService(
        apikey: apiKey,
        latitude: testLat,
        longitude: testLong,
        baseUrl: currentForecastBaseUrl);
    await fiveDayForecastService.getFiveDaysForecast();
    statusCode = fiveDayForecastService.statuCode;
